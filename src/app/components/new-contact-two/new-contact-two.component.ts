...
@Component({
  selector: 'gb-new-contact-two',
  templateUrl: './new-contact-two.component.html',
  styleUrls: ['./new-contact-two.component.scss']
})
export class NewContactTwoComponent implements OnInit {
