...
@Component({
  selector: 'gb-new-company-two',
  templateUrl: './new-company-two.component.html',
  styleUrls: ['./new-company-two.component.scss']
})
export class NewCompanyTwoComponent implements OnInit {
