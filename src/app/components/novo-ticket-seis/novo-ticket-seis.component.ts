...
@Component({
  selector: 'gb-novo-ticket-seis',
  templateUrl: './novo-ticket-seis.component.html',
  styleUrls: ['./novo-ticket-seis.component.scss']
})
export class NovoTicketSeisComponent implements OnInit, OnDestroy {
