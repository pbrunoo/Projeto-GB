...
@Component({
  selector: 'gb-new-contact-three',
  templateUrl: './new-contact-three.component.html',
  styleUrls: ['./new-contact-three.component.scss']
})
export class NewContactThreeComponent implements OnInit {
