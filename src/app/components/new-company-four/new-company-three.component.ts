...
@Component({
  selector: 'gb-new-company-four',
  templateUrl: './new-company-four.component.html',
  styleUrls: ['./new-company-four.component.scss']
})
export class NewCompanyFourComponent implements OnInit {
