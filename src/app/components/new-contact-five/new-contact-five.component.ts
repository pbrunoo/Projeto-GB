...
@Component({
  selector: 'gb-new-contact-five',
  templateUrl: './new-contact-five.component.html',
  styleUrls: ['./new-contact-five.component.scss']
})
export class NewContactFiveComponent implements OnInit {
