...
@Component({
  selector: 'gb-new-contact-six',
  templateUrl: './new-contact-six.component.html',
  styleUrls: ['./new-contact-six.component.scss']
})
export class NewContactSixComponent implements OnInit {
