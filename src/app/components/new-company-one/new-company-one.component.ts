...
@Component({
  selector: 'gb-new-company-one',
  templateUrl: './new-company-one.component.html',
  styleUrls: ['./new-company-one.component.scss']
})
export class NewCompanyOneComponent implements OnInit {
