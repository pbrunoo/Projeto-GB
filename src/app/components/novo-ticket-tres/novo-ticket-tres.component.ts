...
@Component({
  selector: 'gb-novo-ticket-tres',
  templateUrl: './novo-ticket-tres.component.html',
  styleUrls: ['./novo-ticket-tres.component.scss']
})
export class NovoTicketTresComponent implements OnInit, OnDestroy {
  ...
  identifyTabAfterSave() {
    this.sendTab.emit(3);
    this.tabsMenuDataShare.setValue(3);
