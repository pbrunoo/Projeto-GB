...
@Component({
  selector: 'gb-new-company-six',
  templateUrl: './new-company-six.component.html',
  styleUrls: ['./new-company-six.component.scss']
})
export class NewCompanySixComponent implements OnInit {
