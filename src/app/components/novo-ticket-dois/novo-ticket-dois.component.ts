...
@Component({
  selector: 'gb-novo-ticket-dois',
  templateUrl: './novo-ticket-dois.component.html',
  styleUrls: ['./novo-ticket-dois.component.scss']
})
export class NovoTicketDoisComponent implements OnInit, OnDestroy {
  ...
  identifyTabAfterSave() {
    this.sendTab.emit(2);
    this.tabsMenuDataShare.setValue(2);
