...
@Component({
  selector: 'gb-new-company-three',
  templateUrl: './new-company-three.component.html',
  styleUrls: ['./new-company-three.component.scss']
})
export class NewCompanyThreeComponent implements OnInit {
