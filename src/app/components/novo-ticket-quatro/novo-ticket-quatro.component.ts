...
@Component({
  selector: 'gb-novo-ticket-quatro',
  templateUrl: './novo-ticket-quatro.component.html',
  styleUrls: ['./novo-ticket-quatro.component.scss']
})
export class NovoTicketQuatroComponent implements OnInit, OnDestroy {
  ...
  identifyTabAfterSave() {
    this.sendTab.emit(4);
    this.tabsMenuDataShare.setValue(4);
