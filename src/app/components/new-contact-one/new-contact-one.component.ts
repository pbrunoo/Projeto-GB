...
@Component({
  selector: 'gb-new-contact-one',
  templateUrl: './new-contact-one.component.html',
  styleUrls: ['./new-contact-one.component.scss']
})
export class NewContactOneComponent implements OnInit {
